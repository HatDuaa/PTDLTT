...
Kết quả                  & 20--23 & 3:40 \\
\textbf{Demo trực tiếp}  & ---    & \textbf{3:35} \\
...
\textbf{Vượt 55 giây so với 20 phút.} Demo đi hết cả 4 mục của trang \texttt{/demo}
nên dài hơn mốc 2:30 ban đầu.

\textbf{Nếu bị hối, cắt theo thứ tự:} slide 5 $\to$ slide 13 $\to$ slide 4. Ba slide
này là chi tiết kỹ thuật, bỏ đi không ai hỏi. Cắt hai slide đầu (50 giây) là gần như
vừa khít; cắt cả ba thì về 19:35, dôi ra 25 giây.
...
% =====================================================================
\section*{Demo trực tiếp --- 3:35}

\chidan{Mở tab \texttt{/demo}. Trang có 4 mục, kịch bản đi hết cả 4. Hai mục đầu là ví
dụ từng mặt hàng, hai mục sau là kết quả trên toàn mẫu.}

\slidemuc{D1}{Mục 1 --- món duy nhất đạt chuẩn}{50s}{\relax}
...
\slidemuc{D2}{Mục 1 --- món giữ nguyên giá}{50s}{\relax}
...
\slidemuc{D3}{Mục 2 --- máy tính giá}{50s}{\relax}
...
\slidemuc{D4}{Mục 3 --- cùng phép tính đó trên cả mẫu}{15s}{\relax}
\chidan{Cuộn xuống mục 3. Không bấm gì.}
\begin{noi}
Áp đúng phép tính vừa rồi cho từng mặt hàng thì ra hai thanh này. Nhóm được giảm
thuế: \textbf{1 trên 135}. Nhóm đối chứng, lẽ ra không chịu tác động nào:
\textbf{1 trên 92}. Thanh dưới còn dài hơn thanh trên.
\end{noi}

\slidemuc{D5}{Mục 4 --- đổi lựa chọn phân tích}{50s}{\relax}
\chidan{Cuộn xuống mục 4. Để nguyên trục ``Cửa sổ [ITT]'' trong ô chọn.}
\begin{noi}
Mục cuối là phần nhóm tự kiểm: đổi một lựa chọn trong phân tích rồi xem kết quả có
đổi theo không.

Đây là trục cửa sổ thời gian, bốn mức: \textbf{âm 0,27 --- âm 0,11 --- âm 0,21 ---
âm 0,21}. Bốn lần đều âm, bốn lần khoảng tin cậy đều phủ 0. Đổi cửa sổ \textbf{không}
làm đổi kết luận.

Trong ô chọn còn \textbf{9 trục nữa}, và nhóm nói thẳng là \textbf{có hai trục ra
ngược dấu}. Một là khi siết ngưỡng số tuần bán lên 5 tuần --- lúc đó mẫu chỉ còn
\textbf{104 mặt hàng}. Hai là khi đo trên \textbf{giá chưa thuế} thay vì giá gồm thuế
--- cái này thì đúng như phải thế: giá kệ đứng yên mà thuế suất rớt thì phần chưa
thuế buộc phải tăng. Cùng một phát hiện, nhìn từ phía cửa hàng.
\end{noi}

\chidan{Nếu mạng hỏng hoặc web không lên: bỏ qua demo, nói thẳng ba con số 1 trên
135, 110 mặt hàng, và ví dụ VASELINE --- slide 23 đã có đủ. Riêng phần độ nhạy thì
đọc bốn con số âm 0,27 --- âm 0,11 --- âm 0,21 --- âm 0,21; bảng đầy đủ nằm ở phụ lục
báo cáo.}
...
\textbf{``Trong mục 4, ngưỡng 5 tuần lại ra số dương --- vậy kết quả có vững không?''}
\begin{noi}
Ở ngưỡng đó mẫu rơi từ 287 xuống \textbf{104 mặt hàng}, khoảng tin cậy giãn thành
âm 0,75 tới cộng 2,50 --- rộng hơn cả mốc chuyển hoàn toàn. Nó không khẳng định được
gì mà cũng không bác bỏ được gì. Ba ngưỡng còn lại là 1, 3 và 4 tuần đều âm. Và ngưỡng
càng cao thì càng chỉ giữ lại hàng bán chạy, tức là mẫu càng lệch chứ không sạch hơn.
\end{noi}

\textbf{``Đo trên giá chưa thuế thì ra $+1{,}515$ với $p = 0{,}036$ --- ngược hẳn kết
luận của nhóm?''}
\begin{noi}
Đó là cùng một phát hiện chứ không mâu thuẫn. Giá chưa thuế bằng giá gồm thuế chia cho
một cộng thuế suất. Nhóm được giảm thuế có thuế suất rớt, nên nếu giá kệ đứng yên thì
phần chưa thuế \textbf{buộc phải tăng} đúng 1,835 điểm. Kiểm lại bằng số: lấy âm 0,27
cộng 1,835 nhân với tỉ lệ mặt hàng cửa hàng thật sự hạ thuế suất --- 135 trên 155 ---
ra khoảng 1,3, đúng bằng $+1{,}286$ đo được. Nó không phải bằng chứng độc lập; nó đang
kiểm định một giả thuyết khác, là \textbf{giả thuyết chuyển thuế hoàn toàn}, và bác bỏ
giả thuyết đó.

Thêm hai điểm. Con số $p = 0{,}036$ là bản per-protocol, tức hồi quy theo thuế suất
cửa hàng thực áp --- chính cái đặc tả nhóm đã nói là không dùng được vì đó là biến
trung gian. Bản ITT là $+1{,}286$ với $p = 0{,}082$. Và nhóm \textbf{không} phát biểu
chuyện này thành ``cửa hàng lãi thêm'': dữ liệu không có giá vốn nên không nói được gì
về biên lợi nhuận.
\end{noi}
